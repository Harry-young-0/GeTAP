...
# assign a value of 1 or 2, 1 = faster but more likely to error; 2 = slower but less likely to error (DEFAULT= faster)
speed_vs_reliability = 2
...
I NEED TO CONVERT TO GENCODE ID AND WORKOUT HOW TO USE THE V2 API.....
...
progress = length(Gtex_PHEWAS_list)
