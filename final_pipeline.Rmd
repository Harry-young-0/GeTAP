...
ggsave(paste0(file_directory,"/",gene_name,"_test/Final_plots/A-Number of SNPs per Tissue from GTEx .pdf"), width= 150, height=100, unit="mm")
...
ggsave(paste0(file_directory,"/",gene_name,"_test/Final_plots/B-Correlation.pdf"), width= 200, height=100, unit="mm")
...
CPosition_count_OVERVIEW = ggplot(LD_Gtex, aes(x=position_gtex,  fill = NES_direction)) + 
  ...
  scale_fill_viridis_d(name=paste0("NES")) + # I like this palette but you can remove it or change it 
...
DSNP_by_traitgroup
ggsave(paste0(file_directory,"/",gene_name,"_test/Final_plots/D Number of STAs in Each Traitgroup.pdf"), width=200,height=120, unit="mm")
...
temp_pos = df %>% dplyr::filter(NES_direction=="Positive") %>%
  select(traitgroup, beta_direction, rsid, p , trait, NES_direction)%>%
  unique()
...
ggsave(paste0(file_directory,"/",gene_name,"_test/Final_plots/F1--logp_x_expression_change_per_traitgroup.pdf"), width=200, height =100 , units="mm")
```
...
ggsave(paste0(file_directory,"/",gene_name,"_test/Final_plots/F2_no_Other_or_OGEC.pdf"), width=200, height =100 , units="mm")
...
filename=paste0(file_directory,"/",gene_name,"_test/Final_plots/F3_OGEC_only.pdf")
...
filename=paste0(file_directory,"/",gene_name,"_test/Final_plots/F3-2_Other_only.pdf")
...
choices_top =c("Other Gene Expression Change",
           "Number 1 Trait Group",
           "Number 2 Trait Group",
           "Number 3 Trait Group",
           "Number 4 Trait Group",
           "Number 5 Trait Group",
           "Number 6 Trait Group",
           "Number 7 Trait Group",
           "Number 8 Trait Group",
           "Number 9 Trait Group",
           "Number 10 Trait Group",
           "Number 11 Trait Group",
           "Number 12 Trait Group",
           "Number 13 Trait Group",
           "Number 14 Trait Group",
           "Number 15 Trait Group",
           "Number 16 Trait Group",
           "Number 17 Trait Group",
           "Number 18 Trait Group",
           "Number 19 Trait Group",
           "Number 20 Trait Group",
           "Number 21 Trait Group",
           "Number 22 Trait Group",
           "Number 23 Trait Group",
           "Number 24 Trait Group",
           "Number 25 Trait Group"
)
choices_top =choices_top[1:(length(matching_objects)+1)]
save.image(paste0(file_directory,"/", gene_name,"_test/Final_data/final_workspace_for_shiny.RData"))
